...
import dev.mmodrzej.mso.database.NoteDatabase
...
class NoteRepository private constructor(context: Context) {
    ...
    private val database: NoteDatabase = Room.databaseBuilder(context.applicationContext, NoteDatabase::class.java, DATABASE_NAME).build()
